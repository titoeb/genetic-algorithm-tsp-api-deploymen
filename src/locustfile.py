...
TSP_HOST = (
    f"http://{os.environ['TSP_API_SERVICE_PORT_8000_TCP_ADDR']}:{os.environ['TSP_API_SERVICE_PORT_8000_TCP_PORT']}"
)
...
class LoadTest(FastHttpUser):
    ...
    @task(weight=3)
    def test_6_cities(self):
        self.client.post("/tsp", json=SIX_CITIES, name="batch-1")

    @task
    def test_15_cities(self):
        self.client.post(f"/tsp", json=FIFTEEN_CITIES, name="batch-1")

    #     @task
    #     def test_29_cities(self):
    #         request_body = {
    #             "distances": [
    #                 [
    #                     0,
    ...
    #             "n_generations": 400,
    #         }
    #         self.client.post(f"{TSP_HOST}/tsp", json=request_body, name="batch-1")
    ...
    #         self.client.post(f"{TSP_HOST}/tsp", json=FIFTEEN_CITIES, name="batch-1")
